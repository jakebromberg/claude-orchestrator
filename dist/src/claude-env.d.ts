 ...
 */
export declare const API_CREDENTIAL_ENV_VARS: readonly ["ANTHROPIC_API_KEY", "ANTHROPIC_AUTH_TOKEN"];
/** Set to `1`/`true`/`yes`/`on` to bill orchestrated sessions to the Anthropic API instead. */
export declare const USE_API_KEY_ENV_VAR = "CLAUDE_ORCHESTRATOR_USE_API_KEY";
/**
 ...
 */
export declare function usesApiKeyBilling(env?: NodeJS.ProcessEnv): boolean;
/**
 ...
 */
export declare function claudeExecOptions(extra?: {
    cwd?: string;
    input?: string;
}): {
    encoding: "utf-8";
 ...
 */
export declare function authBanner(env?: NodeJS.ProcessEnv): {
    level: "info" | "warn";
    message: string;
};
/**
 ...
 */
export declare function claudeSessionEnv(env?: NodeJS.ProcessEnv, options?: {
    useApiKey?: boolean;
}): NodeJS.ProcessEnv;
